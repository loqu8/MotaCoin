...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    else if (pindexBest->nHeight+1 <= LAST_POW_BLOCK && pindexBest->nHeight+1 >= 2 && pindexBest->nHeight+1 <=  10)
    {
      nSubsidy = 420 * COIN;
      return nSubsidy + nFees;
    }
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "MotaCoin, This one's on us!";
        CTransaction txNew;
        txNew.nTime = 1454469530;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1454469530; // Mon, 07 Sep 2015 20:19:48 GMT
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("f78529e51703e0ccfbbce3979537d47445324742421938ab6713aab9f0617d6b"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0x8C, 0xa8, 0x8B, 0x8A };
